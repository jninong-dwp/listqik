  ...
  return (
    <form
      ...
      onSubmit={async (e) => {
        ...
        const propertyType = String(fd.get("propertyType") ?? "SINGLE_FAMILY").trim();
        const legalLot = String(fd.get("legalLot") ?? "").trim();
        const legalBlock = String(fd.get("legalBlock") ?? "").trim();
        const legalAddition = String(fd.get("legalAddition") ?? "").trim();
        const parcelId = String(fd.get("parcelId") ?? "").trim();
    ...
    >
      ...
      <select
        name="propertyType"
        className="rounded-lg border border-emerald-500/30 bg-black/40 px-3 py-2 text-sm text-emerald-50"
      ...
      <input
        name="legalLot"
        placeholder="Legal Lot (optional)"
        className="rounded-lg border border-emerald-500/30 bg-black/40 px-3 py-2 text-sm text-emerald-50 placeholder:text-emerald-200/40"
      />
      <input
        name="legalBlock"
        placeholder="Legal Block (optional)"
        className="rounded-lg border border-emerald-500/30 bg-black/40 px-3 py-2 text-sm text-emerald-50 placeholder:text-emerald-200/40"
      />
      <input
        name="legalAddition"
        placeholder="Legal Addition (optional)"
        className="rounded-lg border border-emerald-500/30 bg-black/40 px-3 py-2 text-sm text-emerald-50 placeholder:text-emerald-200/40"
      />
      <input
        name="parcelId"
        placeholder="Property Parcel ID (optional)"
        className="rounded-lg border border-emerald-500/30 bg-black/40 px-3 py-2 text-sm text-emerald-50 placeholder:text-emerald-200/40"
      />
      <input
        name="planLabel"
