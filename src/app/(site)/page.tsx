      ...
      <section className="cockpit-hero bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.18),rgba(2,6,3,0.92)_55%)] pt-6 sm:pt-10 lg:pt-14">
        ...
        <Container className="relative z-[2]">
          <div className="cockpit-hud-frame border-emerald-500/20 bg-black/55 p-3 sm:p-5 lg:p-8">
            <div className="mb-4 flex flex-col items-center justify-center gap-2 border-b border-emerald-500/25 pb-3 font-mono text-[9px] tracking-[0.18em] text-emerald-300/80 sm:mb-6 sm:flex-row sm:justify-between sm:gap-3 sm:pb-4 sm:text-[11px] sm:tracking-[0.25em]">
              <span className="text-emerald-300/90">MFD · LISTQIK</span>
              <span className="text-lime-300/90">HUD · TX</span>
      ...
      <section className="pt-8 sm:pt-10 lg:pt-14">
        <Container>
          <div className="grid gap-4 md:grid-cols-3">
            {modules.map((module) => (
              <article key={module.title} className="glass-surface rounded-2xl border border-emerald-500/20 bg-black/45 p-5">
